      ...
      <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        <Card className="border-white/60 bg-white/75 shadow-[0_20px_60px_rgba(202,118,145,0.14)] backdrop-blur-md">
          <CardContent className="space-y-4 p-6 sm:p-8">
            <div className="inline-flex w-fit items-center rounded-full bg-amber-100 px-4 py-1.5 text-sm font-medium text-amber-700">
              Видео
            </div>

            <h1 className="text-3xl font-bold leading-tight sm:text-4xl">
              Видео и живые воспоминания
            </h1>

            <p className="max-w-2xl text-base leading-7 text-stone-700">
              На этой странице будут собраны короткие видео, поздравления и
              памятные моменты, которыми близкие захотят поделиться с мамой.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-white/60 bg-white/70 shadow-[0_20px_60px_rgba(202,118,145,0.1)] backdrop-blur-md">
          <CardContent className="space-y-3 p-6 sm:p-8 text-stone-700">
            ...
            <p>— короткие загруженные видео</p>
            <p>— внешние видео-ссылки</p>
            <p>— тёплые видео-поздравления от семьи</p>
          </CardContent>
        </Card>
      </section>
    </main>
